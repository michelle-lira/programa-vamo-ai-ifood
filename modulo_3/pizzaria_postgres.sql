...
CREATE TABLE pedido_pizza(
    ...
    CONSTRAINT pedido_pizza_fk_id_pedido FOREIGN KEY (id_pedido) REFERENCES pedido (id_pedido),
    CONSTRAINT pedido_pizza_fk_id_pizza FOREIGN KEY (id_pizza) REFERENCES pizza (id_pizza)
);
...
INSERT INTO cliente (nome,email,endereco) VALUES
	 ...
	 ('Marcelo Lopes','m.lopes@fb.com','av. Rocha, numero 2, Rio Vermelho'),
	 ('Helena Alencar','hele22@fb.com','av. das Orquídeas, numero 4, Liberdade'),
	 ('Almeida Santos','santo.almeida@xpto.com','rua das Flores, quadra C, numero 14, Liberdade');

INSERT INTO pizza (nome,descricao,categoria,preco) VALUES
...
INSERT INTO pedido (id_cliente,observacao,tipo_entrega,preco,data_pedido) VALUES
...
INSERT INTO pedido_pizza (id_pedido,id_pizza,quantidade) VALUES
	 (1,11,'Inteira'),
	 (2,5,'Meia'),
	 (2,6,'Meia'),
	 (2,8,'Meia'),
